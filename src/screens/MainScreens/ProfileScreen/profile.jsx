...
const Profile = ({user, theme, isDarkMode, navigation, setInitializing}) => {
    ...
    return (
        <View style={{flex: 1}}>
            <ScreenHeader user={user} theme={theme} isDarkMode={isDarkMode} setInitializing={setInitializing} page={'profile'}/>
